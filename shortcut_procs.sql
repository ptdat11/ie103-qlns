...
AS BEGIN 
	...
	CREATE TABLE LichSuNhapBanSach
	(
	    ID    INT IDENTITY(1, 1) PRIMARY KEY,
...
AS BEGIN 
	...
	ADD CONSTRAINT FK_Sach_LichSuNhapBan__Sach FOREIGN KEY (IDSach)  REFERENCES Sach(ID),
		CONSTRAINT FK_Sach_LichSuNhapBan__LichSu FOREIGN KEY (IDLichSu)  REFERENCES LichSuNhapBanSach(ID)
	...
	ADD CONSTRAINT FK_HoaDon__NhanSu  FOREIGN KEY (IDNhanVienThanhToan)  REFERENCES NhanSu(ID),
		...
		CONSTRAINT FK_HoaDon_LichSuNhapBan FOREIGN KEY (IDLichSu)  REFERENCES LichSuNhapBanSach(ID)
